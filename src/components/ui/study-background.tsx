...
export function StudyBackground({ initialMood = "notebook" }: { initialMood?: StudyMood }) {
  ...
  return (
    <div
      ref={containerRef}
      className={`study-ambient-canvas mood-${mood}`}
      aria-hidden="true"
    >
      ...
      <div className="ambient-doodles-layer">
        ...
        >
          {/* Bulb Glow Behind */}
          <circle cx="50" cy="42" r="28" fill="var(--curva-bulb-glow, rgba(251, 191, 36, 0.25))" />
          {/* Glass Body */}
          <path
          ...
          />
          {/* Screw Base */}
          <rect x="42" y="68" width="16" height="5" rx="1" fill="#94A3B8" stroke="var(--curva-stroke, #263D5B)" strokeWidth="2" />
          <rect x="44" y="74" width="12" height="4" rx="1" fill="#94A3B8" stroke="var(--curva-stroke, #263D5B)" strokeWidth="2" />
          {/* Rays */}
        ...
        >
          ...
          <path d="M 30 38 L 70 38" stroke="var(--curva-stroke, #263D5B)" strokeWidth="2" strokeLinecap="round" strokeDasharray="6 3" />
          <path d="M 30 48 L 65 48" stroke="var(--curva-stroke, #263D5B)" strokeWidth="2" strokeLinecap="round" strokeDasharray="6 3" />
          <path d="M 30 58 L 52 58" stroke="var(--curva-stroke, #263D5B)" strokeWidth="2" strokeLinecap="round" strokeDasharray="6 3" />
          {/* Push Pin */}
          <circle cx="50" cy="18" r="6" fill="#EF4444" stroke="var(--curva-stroke, #263D5B)" strokeWidth="2" />
        </svg>
        ...
        >
          ...
          <line x1="38" y1="22" x2="62" y2="22" stroke="var(--curva-stroke, #263D5B)" strokeWidth="2" />
          <circle cx="38" cy="22" r="3.5" fill="#FBBF24" />
          <circle cx="62" cy="22" r="3.5" fill="#34D399" />

          <line x1="42" y1="40" x2="58" y2="40" stroke="var(--curva-stroke, #263D5B)" strokeWidth="2" />
          <circle cx="42" cy="40" r="3.5" fill="#EC4899" />
          <circle cx="58" cy="40" r="3.5" fill="#3B82F6" />

          <line x1="38" y1="52" x2="62" y2="52" stroke="var(--curva-stroke, #263D5B)" strokeWidth="2" />
          <circle cx="38" cy="52" r="3.5" fill="#38BDF8" />
          <circle cx="62" cy="52" r="3.5" fill="#A855F7" />

          <line x1="42" y1="72" x2="58" y2="72" stroke="var(--curva-stroke, #263D5B)" strokeWidth="2" />
